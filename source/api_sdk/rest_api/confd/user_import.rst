...
To consult general info about import CSV (CSV format...), see the `User Import and Export <http://documentation.xivo.io/en/stable/administration/users/csv_import.html>`_ page.
